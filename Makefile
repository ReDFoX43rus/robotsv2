...
COMPONENT_DIRS := $(IDF_PATH)/components $(abspath src) $(abspath src/cconsole/ccmds) $(abspath src/iobase) $(abspath src/util) $(abspath src/sensors/trh) $(abspath src/userspace) $(abspath src/userspace/obc)
