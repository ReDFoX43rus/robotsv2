...
COMPONENT_DIRS := $(IDF_PATH)/components $(abspath src) $(abspath 3rd-party/RuC/RuC) $(abspath src/cconsole/ccmds) $(abspath src/iobase) $(abspath src/util) $(abspath 3rd-party/lua) $(abspath src/sensors/trh)
